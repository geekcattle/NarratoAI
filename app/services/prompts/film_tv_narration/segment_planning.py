...
## 开场钩子规则
第一段必须是 OST=1 原生视频开场，截取或生成本剧最经典/最高潮的名场面 3~5 秒作为开场钩子（原生视频原声，无额外BGM、无解说旁白）
- 画面需包含强烈肢体冲突或身份反差视觉（如耳光、下跪、甩黑卡、掐脖、持枪对峙），
- 保留原片环境音或角色台词爆点，不做任何后期配音覆盖。
- 画面要求：电影级画质，手持微晃或快速推轨镜头，强对比光影，字幕暂留空。

第二段必须是 OST=0 解说开场，不要直接播放原片。开头参考“人物困境 + 反常信息 + 悬念问题”的公式：
